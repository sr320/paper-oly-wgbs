...
```{r}
myobj_07_1x = processBismarkAln(location = file.list_07, sample.id = list("1","2","3","4","5","6","7","8"), assembly = "v081", read.context="CpG", mincov=1, treatment = c(0,0,0,0,1,1,1,1))
```
