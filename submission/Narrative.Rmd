...
Identification of differentially methylated loci (DML) using R (v3.4.4; R Studio v1.1.383) and the MethylKit R package (v1.4.1), with a minimum of 3x coverage. All code and analyses is available in the following GitHub repository: URL_NEEDED.
