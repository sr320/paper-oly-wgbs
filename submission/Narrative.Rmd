...
A draft genome was generated in order to map bisulfite treated sequence reads. The draft genome for the Olympia oyster was created using a combination of short read sequence data (Illumina HiSeq4000) combined with long read sequence data (PacBio RSII) using PBJelly (PBSuite_15.8.24; English et al, 2012).
...
Genome assembly data were compiled using QUAST (v4.5; Gurevich et al, 2013).
...
--- ADD number of loci different

--- ADD number of regions different 

--- Describe location of DML and DMRs with regard to genes etc


_Differential Methylation_

Twenty seven differenially methylated loci were identified that span 12 contigs. A majority of the DMLs (15)
are located on Contig35213.
