...
Of the `r nrow(cg)` loci in the draft genome `r nrow(cov)` (`r (nrow(cov)/nrow(cg))*100`%) had corresponding reads mapping, with `r nrow(cov5)` loci covered at 5x and `r nrow(cov10)` loci covered at 10x. 
