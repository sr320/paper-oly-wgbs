...
Bedgraph file used to describe location of methylation

```{bash}
head ../data_21/combined_10x.bedgraph
...
```{r}
gm <- read.csv("../data_21/combined_10x.bedgraph", sep="\t", header = FALSE)
...
Where are methylated loci?

```{r}
meth <- filter (gm, V4>50)
...
bismark_dir="/Applications/bioinfo/bismark_v0.21.0"
trimmed="../data"
bowtie2_dir="/Applications/bioinfo/bowtie2-2.3.4.1-macos-x86_64"
genome="/Users/sr320/Desktop/oly"
samtools="/Applications/bioinfo/samtools-1.9/samtools"
...
OUTPUT <http://gannet.fish.washington.edu/Atumefaciens/20181015_oly_WGBSseq_v081/>
...
see <https://gannet.fish.washington.edu/seashell/bu-mox/scrubbed/061421-olyC/combined_bismark_bt2_SE_report.txt>

Of a total of 92 million reads 43.8 % were mapped to the draft genome. Of the 217M cytosines examined, 25.6% were methylated in a CpG context. Cytosines determined to be methylated in the CHG and CHH context was 1.2% and 1.6% respectively.
